...
export type AddToCartMutation = {
  ...
  addItem: {
    ...
    totalUniqueItems?: number | null;
    subTotal: { __typename?: "Money"; formatted: string };
    items: Array<{
      __typename?: "CartItem";
      id: string;
      name?: string | null;
      images?: Array<string | null> | null;
      lineTotal: { __typename?: "Money"; formatted: string };
      unitTotal: { __typename?: "Money"; formatted: string };
    }>;
  };
};
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "totalUniqueItems" },
                },
                {
                  kind: "Field",
...
export const GetCartBydIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetCartBydId" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
} as unknown as DocumentNode<GetCartBydIdQuery, GetCartBydIdQueryVariables>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "RemoveCartItemInput" },
            },
          },
        },
      ],
